...
from ..agents.prompts.classify import INTENT_DEFINITIONS
...
_COMMON_WORDS = {
    ...
    "let", "say", "she", "too", "use", "find", "tell", "what", "help",
    "also", "been", "just", "like", "look", "make", "want", "will", "with",
    "some", "that", "them", "then", "they", "this", "from", "have", "here",
    "know", "more", "much", "need", "over", "such", "take", "than", "very",
    "when", "come", "could", "about", "would", "their", "which", "other",
    "please", "thanks", "hello", "could", "should", "interview", "remote",
}
